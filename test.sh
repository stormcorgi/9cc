...
assert 2 'main() { a=2;z=10; if(a<z) return 2; else return z-a; }'
assert 8 'main() { a=2;z=10; if(a>=z) return 2; else return z-a; }'
assert 2 'main() { a=2;z=2; if(a>=z) return 2; else return z-a; }'
